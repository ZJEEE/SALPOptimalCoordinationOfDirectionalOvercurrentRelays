...
Directional Overcurrent Relays: CASE III"""
...
General_Data = pd.read_excel(f'{path_}/eight_bus_system.xlsx', sheet_name='General_Data')

Specific_Data = pd.read_excel(f'{path_}/eight_bus_system.xlsx', sheet_name='Specific_Data')
...
ps_available = [.5, .6, .8, 1., 1.5, 2., 2.5]
...
title = f'IEEE 8 BUS SYSTEM RESULTS'
...
graphic = plt.gcf()
graphic.savefig(f'{path_}/fig_8bus.png', format='png')
plt.show()
